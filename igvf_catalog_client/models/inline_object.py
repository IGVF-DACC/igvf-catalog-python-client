...
class InlineObject(BaseModel):
    ...
    message: StrictStr
    code: StrictStr
    issues: Optional[List[InlineObjectIssuesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "issues": [InlineObjectIssuesInner.from_dict(_item) for _item in obj["issues"]] if obj.get("issues") is not None else None
        })
        return _obj
