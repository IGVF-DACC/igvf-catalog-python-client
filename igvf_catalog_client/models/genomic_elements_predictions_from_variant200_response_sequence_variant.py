...
class GenomicElementsPredictionsFromVariant200ResponseSequenceVariant(BaseModel):
    """
    ...
    rsid: Optional[List[StrictStr]]
    ref: StrictStr
    alt: StrictStr
    spdi: Optional[StrictStr]
    hgvs: Optional[StrictStr]
