...
class PathwaysFromGenes200ResponseInner(BaseModel):
    """
    ...
    pathway: Optional[PathwaysFromGenes200ResponseInnerPathway] = None
    name: StrictStr
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pathway": PathwaysFromGenes200ResponseInnerPathway.from_dict(obj["pathway"]) if obj.get("pathway") is not None else None,
            "name": obj.get("name")
        })
        return _obj
