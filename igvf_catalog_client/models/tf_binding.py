...
class TfBinding(BaseModel):
    """
    TfBinding
    """ # noqa: E501
    motif: StrictStr
    count: Union[StrictFloat, StrictInt]
    cell_types: List[CellTypes2]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "motif": obj.get("motif"),
            "count": obj.get("count"),
            "cell_types": [CellTypes2.from_dict(_item) for _item in obj["cell_types"]] if obj.get("cell_types") is not None else None
        })
        return _obj
