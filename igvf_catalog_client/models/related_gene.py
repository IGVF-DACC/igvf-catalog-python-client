...
RELATEDGENE_ANY_OF_SCHEMAS = ["GeneCompact", "str"]

class RelatedGene(BaseModel):
    """
    RelatedGene
    """

    # data type: GeneCompact
    anyof_schema_1_validator: Optional[GeneCompact] = None
    # data type: str
    anyof_schema_2_validator: Optional[StrictStr] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[GeneCompact, str]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "GeneCompact", "str" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = RelatedGene.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in RelatedGene with anyOf schemas: GeneCompact, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into RelatedGene with anyOf schemas: GeneCompact, str. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], GeneCompact, str]]:
