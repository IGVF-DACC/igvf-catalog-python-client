...
class PhenotypesFromCodingVariants200ResponseInnerCodingVariant(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["_id", "aapos", "hgvsp", "protein_name", "gene_name", "ref", "alt"]
