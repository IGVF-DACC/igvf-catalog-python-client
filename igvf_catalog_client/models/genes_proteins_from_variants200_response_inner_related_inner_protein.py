...
class GenesProteinsFromVariants200ResponseInnerRelatedInnerProtein(BaseModel):
    """
    GenesProteinsFromVariants200ResponseInnerRelatedInnerProtein
    """ # noqa: E501
    id: StrictStr = Field(alias="_id")
    name: StrictStr
    uniprot_names: List[StrictStr]
    files_filesets: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["_id", "name", "uniprot_names", "files_filesets"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GenesProteinsFromVariants200ResponseInnerRelatedInnerProtein from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GenesProteinsFromVariants200ResponseInnerRelatedInnerProtein from a dict"""
        if obj is None:
            return None
