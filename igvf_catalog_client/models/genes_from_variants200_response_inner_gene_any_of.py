...
class GenesFromVariants200ResponseInnerGeneAnyOf(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["_id", "chr", "start", "end", "gene_type", "name", "strand", "hgnc", "entrez", "collections", "study_sets", "source", "version", "source_url", "synonyms"]
