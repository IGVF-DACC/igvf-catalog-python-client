...
class EnhancerGenePredictions200ResponseInner(BaseModel):
    """
    EnhancerGenePredictions200ResponseInner
    """ # noqa: E501
    gene: GenomicElementsFromGenes200ResponseInnerGeneAnyOf
    elements: EnhancerGenePredictions200ResponseInnerElements
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "gene": GenomicElementsFromGenes200ResponseInnerGeneAnyOf.from_dict(obj["gene"]) if obj.get("gene") is not None else None,
            "elements": EnhancerGenePredictions200ResponseInnerElements.from_dict(obj["elements"]) if obj.get("elements") is not None else None
        })
        return _obj
