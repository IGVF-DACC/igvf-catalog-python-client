...
class BiosamplesFromVariants200ResponseInnerGenomicElementAnyOf(BaseModel):
    """
    ...
    source_annotation: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["_id", "name", "chr", "start", "end", "type", "source", "source_url", "source_annotation"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BiosamplesFromVariants200ResponseInnerGenomicElementAnyOf from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if source_annotation (nullable) is None
        # and model_fields_set contains the field
        if self.source_annotation is None and "source_annotation" in self.model_fields_set:
            _dict['source_annotation'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BiosamplesFromVariants200ResponseInnerGenomicElementAnyOf from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "source_annotation": obj.get("source_annotation")
        })
        return _obj
