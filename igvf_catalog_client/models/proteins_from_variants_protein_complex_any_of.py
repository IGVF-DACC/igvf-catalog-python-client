...
class ProteinsFromVariantsProteinComplexAnyOf(BaseModel):
    ...
    # data type: ProteinBasic
    anyof_schema_2_validator: Optional[ProteinBasic] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[ProteinBasic, str]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "ProteinBasic", "str" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        # validate data type: ProteinBasic
        if not isinstance(v, ProteinBasic):
            error_messages.append(f"Error! Input type `{type(v)}` is not `ProteinBasic`")
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_2_validator: Optional[ProteinBasic] = None
        try:
            instance.actual_instance = ProteinBasic.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], ProteinBasic, str]]:
