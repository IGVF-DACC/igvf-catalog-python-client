...
class GenomicElementsFromVariants200ResponseInnerGenomicElement(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["_id", "name", "chr", "start", "end", "type", "source_annotation", "source", "source_url"]
