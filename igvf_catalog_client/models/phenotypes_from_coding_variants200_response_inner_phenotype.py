...
class PhenotypesFromCodingVariants200ResponseInnerPhenotype(BaseModel):
    """
    PhenotypesFromCodingVariants200ResponseInnerPhenotype
    """ # noqa: E501
    phenotype_id: StrictStr
    phenotype_name: StrictStr
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PhenotypesFromCodingVariants200ResponseInnerPhenotype from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PhenotypesFromCodingVariants200ResponseInnerPhenotype from a dict"""
        if obj is None:
            return None
