...
class GenomicElementsPredictionsFromVariant200Response(BaseModel):
    """
    GenomicElementsPredictionsFromVariant200Response
    """ # noqa: E501
    sequence_variant: GenomicElementsPredictionsFromVariant200ResponseSequenceVariant = Field(alias="sequence variant")
    predictions: GenomicElementsPredictionsFromVariant200ResponsePredictions
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sequence variant": GenomicElementsPredictionsFromVariant200ResponseSequenceVariant.from_dict(obj["sequence variant"]) if obj.get("sequence variant") is not None else None,
            "predictions": GenomicElementsPredictionsFromVariant200ResponsePredictions.from_dict(obj["predictions"]) if obj.get("predictions") is not None else None
        })
        return _obj
