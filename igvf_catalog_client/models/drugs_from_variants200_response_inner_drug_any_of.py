...
class DrugsFromVariants200ResponseInnerDrugAnyOf(BaseModel):
    """
    DrugsFromVariants200ResponseInnerDrugAnyOf
    """ # noqa: E501
    id: StrictStr = Field(alias="_id")
    name: StrictStr
    drug_ontology_terms: Optional[List[StrictStr]] = None
    source: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["_id", "name", "drug_ontology_terms", "source", "source_url", "class", "method", "files_filesets"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_id": obj.get("_id"),
            "name": obj.get("name"),
            "drug_ontology_terms": obj.get("drug_ontology_terms"),
