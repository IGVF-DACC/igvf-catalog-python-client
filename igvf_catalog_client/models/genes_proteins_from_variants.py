...
class GenesProteinsFromVariants(BaseModel):
    """
    GenesProteinsFromVariants
    """ # noqa: E501
    sequence_variant: SequenceVariant9
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sequence_variant": SequenceVariant9.from_dict(obj["sequence_variant"]) if obj.get("sequence_variant") is not None else None,
            "related": [Related.from_dict(_item) for _item in obj["related"]] if obj.get("related") is not None else None
        })
        return _obj
