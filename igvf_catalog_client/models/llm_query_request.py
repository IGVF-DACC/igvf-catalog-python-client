...
class LlmQueryRequest(BaseModel):
    ...
    LlmQueryRequest
    """ # noqa: E501
    query: Annotated[str, Field(strict=True, max_length=5000)]
    password: StrictStr
    verbose: Optional[StrictStr] = 'false'
    __properties: ClassVar[List[str]] = ["query", "password", "verbose"]

    @field_validator('verbose')
    def verbose_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
