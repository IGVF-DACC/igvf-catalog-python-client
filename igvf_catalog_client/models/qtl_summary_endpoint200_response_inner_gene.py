...
class QtlSummaryEndpoint200ResponseInnerGene(BaseModel):
    """
    QtlSummaryEndpoint200ResponseInnerGene
    """ # noqa: E501
    gene_name: StrictStr
    gene_id: StrictStr
    gene_start: Union[StrictFloat, StrictInt]
    gene_end: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["gene_name", "gene_id", "gene_start", "gene_end"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "gene_start": obj.get("gene_start"),
            "gene_end": obj.get("gene_end")
        })
        return _obj
