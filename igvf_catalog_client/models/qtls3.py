...
class Qtls3(BaseModel):
    """
    Qtls3
    """ # noqa: E501
    type: StrictStr
    cell_types: List[CellTypes]
    genes: List[Genes2]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "cell_types": [CellTypes.from_dict(_item) for _item in obj["cell_types"]] if obj.get("cell_types") is not None else None,
            "genes": [Genes2.from_dict(_item) for _item in obj["genes"]] if obj.get("genes") is not None else None
        })
        return _obj
