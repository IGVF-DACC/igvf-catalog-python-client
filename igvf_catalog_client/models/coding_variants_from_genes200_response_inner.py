...
class CodingVariantsFromGenes200ResponseInner(BaseModel):
    """
    CodingVariantsFromGenes200ResponseInner
    """ # noqa: E501
    protein_change: CodingVariantsFromGenes200ResponseInnerProteinChange
    variants: Optional[List[CodingVariantsFromGenes200ResponseInnerVariantsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "protein_change": CodingVariantsFromGenes200ResponseInnerProteinChange.from_dict(obj["protein_change"]) if obj.get("protein_change") is not None else None,
            "variants": [CodingVariantsFromGenes200ResponseInnerVariantsInner.from_dict(_item) for _item in obj["variants"]] if obj.get("variants") is not None else None
        })
        return _obj
