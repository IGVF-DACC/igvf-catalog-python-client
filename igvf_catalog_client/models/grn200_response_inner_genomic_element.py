...
class Grn200ResponseInnerGenomicElement(BaseModel):
    """
    ...
    regulator_gene: StrictStr
    __properties: ClassVar[List[str]] = ["chr", "start", "end", "regulator_gene"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Grn200ResponseInnerGenomicElement from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Grn200ResponseInnerGenomicElement from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "start": obj.get("start"),
            "end": obj.get("end"),
            "regulator_gene": obj.get("regulator_gene")
        })
        return _obj
