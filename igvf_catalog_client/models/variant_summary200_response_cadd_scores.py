...
class VariantSummary200ResponseCaddScores(BaseModel):
    """
    VariantSummary200ResponseCaddScores
    """ # noqa: E501
    raw: Optional[Union[StrictFloat, StrictInt]] = None
    phread: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["raw", "phread"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of VariantSummary200ResponseCaddScores from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if phread (nullable) is None
        # and model_fields_set contains the field
        if self.phread is None and "phread" in self.model_fields_set:
            _dict['phread'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of VariantSummary200ResponseCaddScores from a dict"""
        if obj is None:
            return None
