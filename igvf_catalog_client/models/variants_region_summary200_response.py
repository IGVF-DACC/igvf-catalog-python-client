...
class VariantsRegionSummary200Response(BaseModel):
    """
    VariantsRegionSummary200Response
    """ # noqa: E501
    variant_count: Union[StrictFloat, StrictInt]
    by_method: List[VariantsRegionSummary200ResponseByMethodInner]
    __properties: ClassVar[List[str]] = ["variant_count", "by_method"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in by_method (list)
        _items = []
        if self.by_method:
            for _item_by_method in self.by_method:
                if _item_by_method:
                    _items.append(_item_by_method.to_dict())
            _dict['by_method'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "by_method": [VariantsRegionSummary200ResponseByMethodInner.from_dict(_item) for _item in obj["by_method"]] if obj.get("by_method") is not None else None
        })
        return _obj
