...
class OntologyTermTransitiveClosure200Response(BaseModel):
    """
    OntologyTermTransitiveClosure200Response
    """ # noqa: E501
    vertices: Dict[str, OntologyTermTransitiveClosure200ResponseVerticesValue]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "vertices": dict(
                (_k, OntologyTermTransitiveClosure200ResponseVerticesValue.from_dict(_v))
                for _k, _v in obj["vertices"].items()
            )
            if obj.get("vertices") is not None
            else None,
            "paths": [
                    [OntologyTermTransitiveClosure200ResponsePathsInnerInner.from_dict(_inner_item) for _inner_item in _item]
