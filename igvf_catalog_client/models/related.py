...
class Related(BaseModel):
    ...
    Related
    """ # noqa: E501
    gene: Optional[RelatedGene] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "gene": RelatedGene.from_dict(obj["gene"]) if obj.get("gene") is not None else None,
            "protein": ProteinCompact.from_dict(obj["protein"]) if obj.get("protein") is not None else None,
            "sources": RelatedSources.from_dict(obj["sources"]) if obj.get("sources") is not None else None
        })
        return _obj
