...
class ProteinsFromTranscripts200ResponseInner(BaseModel):
    """
    ProteinsFromTranscripts200ResponseInner
    """ # noqa: E501
    source: Optional[StrictStr] = None
    source_url: Optional[StrictStr] = None
    protein: Optional[ProteinsFromTranscripts200ResponseInnerProtein] = None
    transcript: Optional[TranscriptsFromGenes200ResponseInnerTranscript] = None
    name: StrictStr
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "protein": ProteinsFromTranscripts200ResponseInnerProtein.from_dict(obj["protein"]) if obj.get("protein") is not None else None,
            "transcript": TranscriptsFromGenes200ResponseInnerTranscript.from_dict(obj["transcript"]) if obj.get("transcript") is not None else None,
            "name": obj.get("name")
        })
        return _obj
