...
class OntologyTermParents200ResponseInnerAnyOf(BaseModel):
    """
    OntologyTermParents200ResponseInnerAnyOf
    """ # noqa: E501
    term: ProteinsFromVariants200ResponseInnerBiosampleTermAnyOf
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OntologyTermParents200ResponseInnerAnyOf from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OntologyTermParents200ResponseInnerAnyOf from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "term": ProteinsFromVariants200ResponseInnerBiosampleTermAnyOf.from_dict(obj["term"]) if obj.get("term") is not None else None,
