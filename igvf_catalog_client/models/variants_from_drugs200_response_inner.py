...
class VariantsFromDrugs200ResponseInner(BaseModel):
    """
    VariantsFromDrugs200ResponseInner
    """ # noqa: E501
    sequence_variant: Optional[BiosamplesFromVariants200ResponseInnerVariant] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sequence_variant": BiosamplesFromVariants200ResponseInnerVariant.from_dict(obj["sequence_variant"]) if obj.get("sequence_variant") is not None else None,
            "_to": obj.get("_to"),
