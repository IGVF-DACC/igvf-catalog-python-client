...
class CodingVariantsFromGenes200ResponseInnerProteinChange(BaseModel):
    """
    CodingVariantsFromGenes200ResponseInnerProteinChange
    """ # noqa: E501
    protein_id: Optional[StrictStr] = None
    protein_name: Optional[StrictStr] = None
    transcript_id: Optional[StrictStr] = None
    hgvsp: Optional[StrictStr] = None
    aapos: Optional[Union[StrictFloat, StrictInt]] = None
    ref: Optional[StrictStr] = None
    alt: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["protein_id", "protein_name", "transcript_id", "hgvsp", "aapos", "ref", "alt"]
