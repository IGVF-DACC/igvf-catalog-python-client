...
class MotifsFromProteins(BaseModel):
    """
    MotifsFromProteins
    """ # noqa: E501
    ...
    motif: Optional[MotifsFromProteinsMotif] = None
    name: StrictStr
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "motif": MotifsFromProteinsMotif.from_dict(obj["motif"]) if obj.get("motif") is not None else None,
            "name": obj.get("name"),
            "class": obj.get("class"),
