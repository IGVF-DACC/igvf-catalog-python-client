...
class GenomicElements200ResponseInner(BaseModel):
    """
    ...
    source_annotation: Optional[StrictStr]
    type: StrictStr
    source: StrictStr
    source_url: StrictStr
    __properties: ClassVar[List[str]] = ["chr", "start", "end", "strand", "name", "method", "source_annotation", "type", "source", "source_url"]
