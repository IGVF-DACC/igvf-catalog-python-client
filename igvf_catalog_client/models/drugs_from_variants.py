...
class DrugsFromVariants(BaseModel):
    """
    DrugsFromVariants
    """ # noqa: E501
    drug: Optional[DrugsFromVariantsDrug] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "drug": DrugsFromVariantsDrug.from_dict(obj["drug"]) if obj.get("drug") is not None else None,
            "_from": obj.get("_from"),
