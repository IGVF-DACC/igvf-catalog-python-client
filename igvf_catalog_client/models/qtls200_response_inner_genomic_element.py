...
class Qtls200ResponseInnerGenomicElement(BaseModel):
    """
    ...
    stop: Union[StrictFloat, StrictInt]
    type: StrictStr
    __properties: ClassVar[List[str]] = ["name", "chr", "start", "stop", "type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Qtls200ResponseInnerGenomicElement from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Qtls200ResponseInnerGenomicElement from a dict"""
        if obj is None:
            return None
