...
class ProteinsFromVariants200ResponseInnerBiosampleTermAnyOf(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["uri", "term_id", "name", "synonyms", "description", "source", "subontology", "source_url", "class", "method", "files_filesets"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProteinsFromVariants200ResponseInnerBiosampleTermAnyOf from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProteinsFromVariants200ResponseInnerBiosampleTermAnyOf from a dict"""
        if obj is None:
            return None
