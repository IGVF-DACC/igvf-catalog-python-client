...
class Qtls200ResponseInnerStudy(BaseModel):
    """
    Qtls200ResponseInnerStudy
    """ # noqa: E501
    id: StrictStr
    pmid: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "pmid"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Qtls200ResponseInnerStudy from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Qtls200ResponseInnerStudy from a dict"""
        if obj is None:
            return None
