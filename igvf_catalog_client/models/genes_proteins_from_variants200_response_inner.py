...
class GenesProteinsFromVariants200ResponseInner(BaseModel):
    """
    GenesProteinsFromVariants200ResponseInner
    """ # noqa: E501
    sequence_variant: GenesProteinsFromVariants200ResponseInnerSequenceVariant
    related: List[GenesProteinsFromVariants200ResponseInnerRelatedInner]
    __properties: ClassVar[List[str]] = ["sequence_variant", "related"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sequence_variant": GenesProteinsFromVariants200ResponseInnerSequenceVariant.from_dict(obj["sequence_variant"]) if obj.get("sequence_variant") is not None else None,
            "related": [GenesProteinsFromVariants200ResponseInnerRelatedInner.from_dict(_item) for _item in obj["related"]] if obj.get("related") is not None else None
        })
        return _obj
