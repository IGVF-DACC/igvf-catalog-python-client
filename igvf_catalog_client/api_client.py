...
from igvf_catalog_client.configuration import Configuration
from igvf_catalog_client.api_response import ApiResponse, T as ApiResponseT
import igvf_catalog_client.models
from igvf_catalog_client import rest
from igvf_catalog_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(igvf_catalog_client.models, klass)
