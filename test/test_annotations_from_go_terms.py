...
class TestAnnotationsFromGoTerms(unittest.TestCase):
    """AnnotationsFromGoTerms unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnnotationsFromGoTerms:
        """Test AnnotationsFromGoTerms
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnnotationsFromGoTerms`
        """
        model = AnnotationsFromGoTerms()
        if include_optional:
            return AnnotationsFromGoTerms(
                gene_product_id = '',
                gene_product_name = '',
                go_term_name = '',
                source = '',
    ...
    def testAnnotationsFromGoTerms(self):
        """Test AnnotationsFromGoTerms"""
