...
class TestDiseaseFromVariants(unittest.TestCase):
    """DiseaseFromVariants unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DiseaseFromVariants:
        """Test DiseaseFromVariants
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DiseaseFromVariants`
        """
        model = DiseaseFromVariants()
        if include_optional:
            return DiseaseFromVariants(
    ...
    def testDiseaseFromVariants(self):
        """Test DiseaseFromVariants"""
