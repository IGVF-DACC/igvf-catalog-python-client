...
class TestGenesFromTranscriptsTranscript(unittest.TestCase):
    """GenesFromTranscriptsTranscript unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenesFromTranscriptsTranscript:
        """Test GenesFromTranscriptsTranscript
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenesFromTranscriptsTranscript`
        """
        model = GenesFromTranscriptsTranscript()
        if include_optional:
            return GenesFromTranscriptsTranscript(
                id = '',
                transcript_type = '',
                chr = '',
                start = 1.337,
    ...
    def testGenesFromTranscriptsTranscript(self):
        """Test GenesFromTranscriptsTranscript"""
