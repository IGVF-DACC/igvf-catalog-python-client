...
class TestMotifsFromProteinsMotif(unittest.TestCase):
    """MotifsFromProteinsMotif unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MotifsFromProteinsMotif:
        """Test MotifsFromProteinsMotif
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MotifsFromProteinsMotif`
        """
        model = MotifsFromProteinsMotif()
        if include_optional:
            return MotifsFromProteinsMotif(
                name = '',
                tf_name = '',
                length = 1.337,
                pwm = [
    ...
    def testMotifsFromProteinsMotif(self):
        """Test MotifsFromProteinsMotif"""
