...
class TestEnhancerGenePredictions(unittest.TestCase):
    """EnhancerGenePredictions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EnhancerGenePredictions:
        """Test EnhancerGenePredictions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnhancerGenePredictions`
        """
        model = EnhancerGenePredictions()
        if include_optional:
            return EnhancerGenePredictions(
                gene = igvf_catalog_client.models.gene_ref.GeneRef(
                    name = '', 
                    _id = '', 
                    start = 1.337, 
                    end = 1.337, 
    ...
    def testEnhancerGenePredictions(self):
        """Test EnhancerGenePredictions"""
