...
class TestGenesFromVariants(unittest.TestCase):
    """GenesFromVariants unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenesFromVariants:
        """Test GenesFromVariants
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenesFromVariants`
        """
        model = GenesFromVariants()
        if include_optional:
            return GenesFromVariants(
                gene = None,
    ...
    def testGenesFromVariants(self):
        """Test GenesFromVariants"""
