...
class TestBiosamplesFromVariants(unittest.TestCase):
    """BiosamplesFromVariants unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BiosamplesFromVariants:
        """Test BiosamplesFromVariants
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BiosamplesFromVariants`
        """
        model = BiosamplesFromVariants()
        if include_optional:
            return BiosamplesFromVariants(
                variant = None,
                biosample = None,
    ...
    def testBiosamplesFromVariants(self):
        """Test BiosamplesFromVariants"""
