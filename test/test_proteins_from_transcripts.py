...
class TestProteinsFromTranscripts(unittest.TestCase):
    """ProteinsFromTranscripts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProteinsFromTranscripts:
        """Test ProteinsFromTranscripts
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProteinsFromTranscripts`
        """
        model = ProteinsFromTranscripts()
        if include_optional:
            return ProteinsFromTranscripts(
                source = '',
                source_url = '',
                protein = None,
                transcript = None,
    ...
    def testProteinsFromTranscripts(self):
        """Test ProteinsFromTranscripts"""
