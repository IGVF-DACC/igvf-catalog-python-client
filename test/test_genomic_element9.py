...
class TestGenomicElement9(unittest.TestCase):
    """GenomicElement9 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenomicElement9:
        """Test GenomicElement9
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenomicElement9`
        """
        model = GenomicElement9()
        if include_optional:
            return GenomicElement9(
                id = '',
                name = '',
                chr = '',
                start = 1.337,
