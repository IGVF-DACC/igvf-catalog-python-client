...
class TestGenomicElement8(unittest.TestCase):
    """GenomicElement8 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenomicElement8:
        """Test GenomicElement8
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenomicElement8`
        """
        model = GenomicElement8()
        if include_optional:
            return GenomicElement8(
                id = '',
                name = '',
                chr = '',
                start = 1.337,
