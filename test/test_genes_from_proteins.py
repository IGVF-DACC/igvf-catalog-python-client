...
class TestGenesFromProteins(unittest.TestCase):
    """GenesFromProteins unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenesFromProteins:
        """Test GenesFromProteins
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenesFromProteins`
        """
        model = GenesFromProteins()
        if include_optional:
            return GenesFromProteins(
                gene = None,
                protein = None
            )
        else:
    ...
    def testGenesFromProteins(self):
        """Test GenesFromProteins"""
