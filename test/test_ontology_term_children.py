...
class TestOntologyTermChildren(unittest.TestCase):
    """OntologyTermChildren unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OntologyTermChildren:
        """Test OntologyTermChildren
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OntologyTermChildren`
        """
        model = OntologyTermChildren()
        if include_optional:
            return OntologyTermChildren(
    ...
    def testOntologyTermChildren(self):
        """Test OntologyTermChildren"""
