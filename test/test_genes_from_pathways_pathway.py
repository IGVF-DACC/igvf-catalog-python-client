...
class TestGenesFromPathwaysPathway(unittest.TestCase):
    """GenesFromPathwaysPathway unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenesFromPathwaysPathway:
        """Test GenesFromPathwaysPathway
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenesFromPathwaysPathway`
        """
        model = GenesFromPathwaysPathway()
        if include_optional:
            return GenesFromPathwaysPathway(
                id = '',
                name = '',
                organism = '',
                source = '',
    ...
    def testGenesFromPathwaysPathway(self):
        """Test GenesFromPathwaysPathway"""
