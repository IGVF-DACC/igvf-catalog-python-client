...
class TestGenomicElementFull(unittest.TestCase):
    """GenomicElementFull unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenomicElementFull:
        """Test GenomicElementFull
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenomicElementFull`
        """
        model = GenomicElementFull()
        if include_optional:
            return GenomicElementFull(
                chr = '',
                start = 1.337,
                end = 1.337,
                strand = '',
    ...
    def testGenomicElementFull(self):
        """Test GenomicElementFull"""
