...
class TestPathwaysFromPathways(unittest.TestCase):
    """PathwaysFromPathways unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PathwaysFromPathways:
        """Test PathwaysFromPathways
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PathwaysFromPathways`
        """
        model = PathwaysFromPathways()
        if include_optional:
            return PathwaysFromPathways(
                source = '',
                source_url = '',
                orgnism = '',
                organism = '',
    ...
    def testPathwaysFromPathways(self):
        """Test PathwaysFromPathways"""
