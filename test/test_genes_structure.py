...
class TestGenesStructure(unittest.TestCase):
    """GenesStructure unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenesStructure:
        """Test GenesStructure
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenesStructure`
        """
        model = GenesStructure()
        if include_optional:
            return GenesStructure(
                id = '',
                name = '',
                chr = '',
                start = 1.337,
