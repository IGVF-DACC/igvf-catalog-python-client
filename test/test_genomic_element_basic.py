...
class TestGenomicElementBasic(unittest.TestCase):
    """GenomicElementBasic unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenomicElementBasic:
        """Test GenomicElementBasic
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenomicElementBasic`
        """
        model = GenomicElementBasic()
        if include_optional:
            return GenomicElementBasic(
                id = '',
                type = '',
                chr = '',
                start = 1.337,
    ...
    def testGenomicElementBasic(self):
        """Test GenomicElementBasic"""
