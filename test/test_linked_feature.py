...
class TestLinkedFeature(unittest.TestCase):
    """LinkedFeature unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinkedFeature:
        """Test LinkedFeature
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinkedFeature`
        """
        model = LinkedFeature()
        if include_optional:
