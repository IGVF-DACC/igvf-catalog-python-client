...
class TestPhenotypesFromVariants(unittest.TestCase):
    """PhenotypesFromVariants unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PhenotypesFromVariants:
        """Test PhenotypesFromVariants
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PhenotypesFromVariants`
        """
        model = PhenotypesFromVariants()
        if include_optional:
            return PhenotypesFromVariants(
                rsid = [
                    ''
                    ],
                phenotype_id = '',
    ...
    def testPhenotypesFromVariants(self):
        """Test PhenotypesFromVariants"""
