...
class TestPhenotypesFromVariantsVariant(unittest.TestCase):
    """PhenotypesFromVariantsVariant unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PhenotypesFromVariantsVariant:
        """Test PhenotypesFromVariantsVariant
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PhenotypesFromVariantsVariant`
        """
        model = PhenotypesFromVariantsVariant()
        if include_optional:
            return PhenotypesFromVariantsVariant(
                chr = '',
                pos = 1.337,
                ref = '',
                alt = '',
    ...
    def testPhenotypesFromVariantsVariant(self):
        """Test PhenotypesFromVariantsVariant"""
