...
class TestGeneCompact(unittest.TestCase):
    """GeneCompact unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeneCompact:
        """Test GeneCompact
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeneCompact`
        """
        model = GeneCompact()
        if include_optional:
            return GeneCompact(
