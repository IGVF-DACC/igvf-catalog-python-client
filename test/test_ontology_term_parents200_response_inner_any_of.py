...
class TestOntologyTermParents200ResponseInnerAnyOf(unittest.TestCase):
    """OntologyTermParents200ResponseInnerAnyOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OntologyTermParents200ResponseInnerAnyOf:
        """Test OntologyTermParents200ResponseInnerAnyOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OntologyTermParents200ResponseInnerAnyOf`
        """
        model = OntologyTermParents200ResponseInnerAnyOf()
        if include_optional:
            return OntologyTermParents200ResponseInnerAnyOf(
    ...
    def testOntologyTermParents200ResponseInnerAnyOf(self):
        """Test OntologyTermParents200ResponseInnerAnyOf"""
