...
class TestSources4(unittest.TestCase):
    """Sources4 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Sources4:
        """Test Sources4
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Sources4`
        """
        model = Sources4()
        if include_optional:
            return Sources4(
