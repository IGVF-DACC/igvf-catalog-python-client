...
class TestNearestGenes(unittest.TestCase):
    """NearestGenes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NearestGenes:
        """Test NearestGenes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NearestGenes`
        """
        model = NearestGenes()
        if include_optional:
            return NearestGenes(
