...
class TestCodingVariant(unittest.TestCase):
    """CodingVariant unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CodingVariant:
        """Test CodingVariant
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CodingVariant`
        """
        model = CodingVariant()
        if include_optional:
            return CodingVariant(
                id = '',
                aapos = 1.337,
                hgvsp = '',
                protein_name = '',
