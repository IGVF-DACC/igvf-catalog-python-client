...
class TestGenesFromVariantsStudy(unittest.TestCase):
    """GenesFromVariantsStudy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenesFromVariantsStudy:
        """Test GenesFromVariantsStudy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenesFromVariantsStudy`
        """
        model = GenesFromVariantsStudy()
        if include_optional:
            return GenesFromVariantsStudy(
                id = '',
                name = '',
                ancestry_initial = '',
    ...
    def testGenesFromVariantsStudy(self):
        """Test GenesFromVariantsStudy"""
