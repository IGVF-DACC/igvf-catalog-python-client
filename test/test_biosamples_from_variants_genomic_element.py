...
class TestBiosamplesFromVariantsGenomicElement(unittest.TestCase):
    """BiosamplesFromVariantsGenomicElement unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BiosamplesFromVariantsGenomicElement:
        """Test BiosamplesFromVariantsGenomicElement
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BiosamplesFromVariantsGenomicElement`
        """
        model = BiosamplesFromVariantsGenomicElement()
        if include_optional:
            return BiosamplesFromVariantsGenomicElement(
                id = '',
                name = '',
                chr = '',
                start = 1.337,
    ...
    def testBiosamplesFromVariantsGenomicElement(self):
        """Test BiosamplesFromVariantsGenomicElement"""
