...
class TestGenesFromVariants200ResponseInnerGene(unittest.TestCase):
    """GenesFromVariants200ResponseInnerGene unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenesFromVariants200ResponseInnerGene:
        """Test GenesFromVariants200ResponseInnerGene
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenesFromVariants200ResponseInnerGene`
        """
        model = GenesFromVariants200ResponseInnerGene()
        if include_optional:
            return GenesFromVariants200ResponseInnerGene(
                id = '',
                chr = '',
                start = 1.337,
                end = 1.337,
    ...
    def testGenesFromVariants200ResponseInnerGene(self):
        """Test GenesFromVariants200ResponseInnerGene"""
