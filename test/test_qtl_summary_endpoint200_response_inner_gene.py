...
class TestQtlSummaryEndpoint200ResponseInnerGene(unittest.TestCase):
    """QtlSummaryEndpoint200ResponseInnerGene unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QtlSummaryEndpoint200ResponseInnerGene:
        """Test QtlSummaryEndpoint200ResponseInnerGene
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QtlSummaryEndpoint200ResponseInnerGene`
        """
        model = QtlSummaryEndpoint200ResponseInnerGene()
        if include_optional:
            return QtlSummaryEndpoint200ResponseInnerGene(
                gene_name = '',
                gene_id = '',
                gene_start = 1.337,
                gene_end = 1.337
    ...
    def testQtlSummaryEndpoint200ResponseInnerGene(self):
        """Test QtlSummaryEndpoint200ResponseInnerGene"""
