...
class TestGenesFromVariantsGene(unittest.TestCase):
    """GenesFromVariantsGene unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenesFromVariantsGene:
        """Test GenesFromVariantsGene
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenesFromVariantsGene`
        """
        model = GenesFromVariantsGene()
        if include_optional:
            return GenesFromVariantsGene(
                id = '',
                chr = '',
                start = 1.337,
                end = 1.337,
    ...
    def testGenesFromVariantsGene(self):
        """Test GenesFromVariantsGene"""
