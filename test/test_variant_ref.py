...
class TestVariantRef(unittest.TestCase):
    """VariantRef unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VariantRef:
        """Test VariantRef
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VariantRef`
        """
        model = VariantRef()
        if include_optional:
            return VariantRef(
