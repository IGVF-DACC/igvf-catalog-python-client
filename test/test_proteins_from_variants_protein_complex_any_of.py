...
class TestProteinsFromVariantsProteinComplexAnyOf(unittest.TestCase):
    """ProteinsFromVariantsProteinComplexAnyOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProteinsFromVariantsProteinComplexAnyOf:
        """Test ProteinsFromVariantsProteinComplexAnyOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProteinsFromVariantsProteinComplexAnyOf`
        """
        model = ProteinsFromVariantsProteinComplexAnyOf()
        if include_optional:
            return ProteinsFromVariantsProteinComplexAnyOf(
                id = '',
                name = '',
                uniprot_names = [
                    ''
    ...
    def testProteinsFromVariantsProteinComplexAnyOf(self):
        """Test ProteinsFromVariantsProteinComplexAnyOf"""
