...
class TestQtlSummaryEndpoint(unittest.TestCase):
    """QtlSummaryEndpoint unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QtlSummaryEndpoint:
        """Test QtlSummaryEndpoint
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QtlSummaryEndpoint`
        """
        model = QtlSummaryEndpoint()
        if include_optional:
            return QtlSummaryEndpoint(
                qtl_type = '',
                neg_log10_pvalue = 1.337,
                chr = '',
                biological_context = '',
                effect_size = 1.337,
                gene = igvf_catalog_client.models.gene4.Gene4(
                    gene_name = '', 
                    gene_id = '', 
                    gene_start = 1.337, 
                    gene_end = 1.337, ),
    ...
    def testQtlSummaryEndpoint(self):
        """Test QtlSummaryEndpoint"""
