...
class TestEnhancerGenePredictionsElements(unittest.TestCase):
    """EnhancerGenePredictionsElements unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EnhancerGenePredictionsElements:
        """Test EnhancerGenePredictionsElements
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnhancerGenePredictionsElements`
        """
        model = EnhancerGenePredictionsElements()
        if include_optional:
            return EnhancerGenePredictionsElements(
                id = '',
                cell_type = '',
                score = 1.337,
                model = '',
    ...
    def testEnhancerGenePredictionsElements(self):
        """Test EnhancerGenePredictionsElements"""
