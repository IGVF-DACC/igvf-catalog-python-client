...
class TestQtls200ResponseInnerVariant(unittest.TestCase):
    """Qtls200ResponseInnerVariant unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Qtls200ResponseInnerVariant:
        """Test Qtls200ResponseInnerVariant
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Qtls200ResponseInnerVariant`
        """
        model = Qtls200ResponseInnerVariant()
        if include_optional:
            return Qtls200ResponseInnerVariant(
                chr = '',
                pos = 1.337,
                spdi = '',
                rsid = None,
    ...
    def testQtls200ResponseInnerVariant(self):
        """Test Qtls200ResponseInnerVariant"""
