...
class TestAutocomplete200ResponseInner(unittest.TestCase):
    """Autocomplete200ResponseInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Autocomplete200ResponseInner:
        """Test Autocomplete200ResponseInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Autocomplete200ResponseInner`
        """
        model = Autocomplete200ResponseInner()
        if include_optional:
            return Autocomplete200ResponseInner(
                term = '',
                type = '',
                name = '',
                uri = ''
    ...
    def testAutocomplete200ResponseInner(self):
        """Test Autocomplete200ResponseInner"""
