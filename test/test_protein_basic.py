...
class TestProteinBasic(unittest.TestCase):
    """ProteinBasic unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProteinBasic:
        """Test ProteinBasic
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProteinBasic`
        """
        model = ProteinBasic()
        if include_optional:
            return ProteinBasic(
