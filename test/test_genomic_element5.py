...
class TestGenomicElement5(unittest.TestCase):
    """GenomicElement5 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenomicElement5:
        """Test GenomicElement5
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenomicElement5`
        """
        model = GenomicElement5()
        if include_optional:
            return GenomicElement5(
                name = '',
                chr = '',
                start = 1.337,
                stop = 1.337,
