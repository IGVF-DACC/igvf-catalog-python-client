...
class TestPathwaysFromGenes200ResponseInnerPathwayAnyOf(unittest.TestCase):
    """PathwaysFromGenes200ResponseInnerPathwayAnyOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PathwaysFromGenes200ResponseInnerPathwayAnyOf:
        """Test PathwaysFromGenes200ResponseInnerPathwayAnyOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PathwaysFromGenes200ResponseInnerPathwayAnyOf`
        """
        model = PathwaysFromGenes200ResponseInnerPathwayAnyOf()
        if include_optional:
            return PathwaysFromGenes200ResponseInnerPathwayAnyOf(
                id = '',
                name = '',
                organism = '',
                source = '',
    ...
    def testPathwaysFromGenes200ResponseInnerPathwayAnyOf(self):
        """Test PathwaysFromGenes200ResponseInnerPathwayAnyOf"""
