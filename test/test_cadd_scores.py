...
class TestCaddScores(unittest.TestCase):
    """CaddScores unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CaddScores:
        """Test CaddScores
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CaddScores`
        """
        model = CaddScores()
        if include_optional:
            return CaddScores(
