...
class TestTranscriptsFromGenes200ResponseInner(unittest.TestCase):
    """TranscriptsFromGenes200ResponseInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TranscriptsFromGenes200ResponseInner:
        """Test TranscriptsFromGenes200ResponseInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TranscriptsFromGenes200ResponseInner`
        """
        model = TranscriptsFromGenes200ResponseInner()
        if include_optional:
            return TranscriptsFromGenes200ResponseInner(
                source = '',
                source_url = '',
                version = '',
                gene = None,
    ...
    def testTranscriptsFromGenes200ResponseInner(self):
        """Test TranscriptsFromGenes200ResponseInner"""
