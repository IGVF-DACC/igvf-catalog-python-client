...
class TestCellTypes2(unittest.TestCase):
    """CellTypes2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CellTypes2:
        """Test CellTypes2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CellTypes2`
        """
        model = CellTypes2()
        if include_optional:
            return CellTypes2(
