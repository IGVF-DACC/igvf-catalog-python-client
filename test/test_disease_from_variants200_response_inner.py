...
class TestDiseaseFromVariants200ResponseInner(unittest.TestCase):
    """DiseaseFromVariants200ResponseInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DiseaseFromVariants200ResponseInner:
        """Test DiseaseFromVariants200ResponseInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DiseaseFromVariants200ResponseInner`
        """
        model = DiseaseFromVariants200ResponseInner()
        if include_optional:
            return DiseaseFromVariants200ResponseInner(
    ...
    def testDiseaseFromVariants200ResponseInner(self):
        """Test DiseaseFromVariants200ResponseInner"""
