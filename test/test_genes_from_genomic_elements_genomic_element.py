...
class TestGenesFromGenomicElementsGenomicElement(unittest.TestCase):
    """GenesFromGenomicElementsGenomicElement unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenesFromGenomicElementsGenomicElement:
        """Test GenesFromGenomicElementsGenomicElement
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenesFromGenomicElementsGenomicElement`
        """
        model = GenesFromGenomicElementsGenomicElement()
        if include_optional:
            return GenesFromGenomicElementsGenomicElement(
                id = '',
                type = '',
                chr = '',
                start = 1.337,
    ...
    def testGenesFromGenomicElementsGenomicElement(self):
        """Test GenesFromGenomicElementsGenomicElement"""
