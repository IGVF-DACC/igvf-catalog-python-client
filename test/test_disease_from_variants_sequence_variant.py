...
class TestDiseaseFromVariantsSequenceVariant(unittest.TestCase):
    """DiseaseFromVariantsSequenceVariant unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DiseaseFromVariantsSequenceVariant:
        """Test DiseaseFromVariantsSequenceVariant
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DiseaseFromVariantsSequenceVariant`
        """
        model = DiseaseFromVariantsSequenceVariant()
        if include_optional:
            return DiseaseFromVariantsSequenceVariant(
                chr = '',
                pos = 1.337,
                ref = '',
                alt = '',
    ...
    def testDiseaseFromVariantsSequenceVariant(self):
        """Test DiseaseFromVariantsSequenceVariant"""
