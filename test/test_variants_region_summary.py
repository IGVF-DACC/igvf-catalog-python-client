...
class TestVariantsRegionSummary(unittest.TestCase):
    """VariantsRegionSummary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VariantsRegionSummary:
        """Test VariantsRegionSummary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VariantsRegionSummary`
        """
        model = VariantsRegionSummary()
        if include_optional:
            return VariantsRegionSummary(
                variant_count = 1.337,
                by_method = [
                    igvf_catalog_client.models.method_count.MethodCount(
                        method = '', 
                        count = 1.337, )
                    ]
            )
    ...
    def testVariantsRegionSummary(self):
        """Test VariantsRegionSummary"""
