...
class TestMotifsFromProteins(unittest.TestCase):
    """MotifsFromProteins unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MotifsFromProteins:
        """Test MotifsFromProteins
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MotifsFromProteins`
        """
        model = MotifsFromProteins()
        if include_optional:
            return MotifsFromProteins(
                source = '',
                protein = None,
                complex = None,
                motif = None,
    ...
    def testMotifsFromProteins(self):
        """Test MotifsFromProteins"""
