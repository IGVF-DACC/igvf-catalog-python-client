...
class TestComplexesFromProteinsProtein(unittest.TestCase):
    """ComplexesFromProteinsProtein unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ComplexesFromProteinsProtein:
        """Test ComplexesFromProteinsProtein
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ComplexesFromProteinsProtein`
        """
        model = ComplexesFromProteinsProtein()
        if include_optional:
            return ComplexesFromProteinsProtein(
                id = '',
                name = '',
                uniprot_names = [
                    ''
                ...
                dbxrefs = [
                    igvf_catalog_client.models.id_name.IdName(
                        name = '', 
                        id = '', )
                    ],
                mane_select = True,
    ...
    def testComplexesFromProteinsProtein(self):
        """Test ComplexesFromProteinsProtein"""
