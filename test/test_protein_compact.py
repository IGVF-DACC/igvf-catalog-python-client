...
class TestProteinCompact(unittest.TestCase):
    """ProteinCompact unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProteinCompact:
        """Test ProteinCompact
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProteinCompact`
        """
        model = ProteinCompact()
        if include_optional:
            return ProteinCompact(
                id = '',
                name = '',
                uniprot_names = [
                    ''
