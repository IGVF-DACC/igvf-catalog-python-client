...
class TestGenesFromPathways(unittest.TestCase):
    """GenesFromPathways unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenesFromPathways:
        """Test GenesFromPathways
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenesFromPathways`
        """
        model = GenesFromPathways()
        if include_optional:
            return GenesFromPathways(
                source = '',
                source_url = '',
                orgnism = '',
                organism = '',
    ...
    def testGenesFromPathways(self):
        """Test GenesFromPathways"""
