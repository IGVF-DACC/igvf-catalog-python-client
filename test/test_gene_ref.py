...
class TestGeneRef(unittest.TestCase):
    """GeneRef unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeneRef:
        """Test GeneRef
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeneRef`
        """
        model = GeneRef()
        if include_optional:
            return GeneRef(
