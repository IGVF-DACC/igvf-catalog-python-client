...
class TestVariantMinimal(unittest.TestCase):
    """VariantMinimal unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VariantMinimal:
        """Test VariantMinimal
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VariantMinimal`
        """
        model = VariantMinimal()
        if include_optional:
