...
class TestOntologyTermBasic(unittest.TestCase):
    """OntologyTermBasic unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OntologyTermBasic:
        """Test OntologyTermBasic
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OntologyTermBasic`
        """
        model = OntologyTermBasic()
        if include_optional:
            return OntologyTermBasic(
                uri = '',
                term_id = '',
                name = '',
                synonyms = [
    ...
    def testOntologyTermBasic(self):
        """Test OntologyTermBasic"""
