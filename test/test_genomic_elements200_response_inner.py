...
class TestGenomicElements200ResponseInner(unittest.TestCase):
    """GenomicElements200ResponseInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenomicElements200ResponseInner:
        """Test GenomicElements200ResponseInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenomicElements200ResponseInner`
        """
        model = GenomicElements200ResponseInner()
        if include_optional:
            return GenomicElements200ResponseInner(
                chr = '',
                start = 1.337,
                end = 1.337,
                strand = '',
    ...
    def testGenomicElements200ResponseInner(self):
        """Test GenomicElements200ResponseInner"""
