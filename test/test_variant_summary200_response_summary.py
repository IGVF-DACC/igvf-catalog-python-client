...
class TestVariantSummary200ResponseSummary(unittest.TestCase):
    """VariantSummary200ResponseSummary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VariantSummary200ResponseSummary:
        """Test VariantSummary200ResponseSummary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VariantSummary200ResponseSummary`
        """
        model = VariantSummary200ResponseSummary()
        if include_optional:
            return VariantSummary200ResponseSummary(
                rsid = [
                    ''
                    ],
                varinfo = '',
    ...
    def testVariantSummary200ResponseSummary(self):
        """Test VariantSummary200ResponseSummary"""
