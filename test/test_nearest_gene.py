...
class TestNearestGene(unittest.TestCase):
    """NearestGene unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NearestGene:
        """Test NearestGene
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NearestGene`
        """
        model = NearestGene()
        if include_optional:
            return NearestGene(
