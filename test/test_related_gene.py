...
class TestRelatedGene(unittest.TestCase):
    """RelatedGene unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RelatedGene:
        """Test RelatedGene
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RelatedGene`
        """
        model = RelatedGene()
        if include_optional:
            return RelatedGene(
