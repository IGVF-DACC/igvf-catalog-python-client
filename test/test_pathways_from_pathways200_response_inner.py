...
class TestPathwaysFromPathways200ResponseInner(unittest.TestCase):
    """PathwaysFromPathways200ResponseInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PathwaysFromPathways200ResponseInner:
        """Test PathwaysFromPathways200ResponseInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PathwaysFromPathways200ResponseInner`
        """
        model = PathwaysFromPathways200ResponseInner()
        if include_optional:
            return PathwaysFromPathways200ResponseInner(
                source = '',
                source_url = '',
                orgnism = '',
                organism = '',
    ...
    def testPathwaysFromPathways200ResponseInner(self):
        """Test PathwaysFromPathways200ResponseInner"""
