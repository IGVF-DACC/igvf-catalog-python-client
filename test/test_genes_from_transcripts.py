...
class TestGenesFromTranscripts(unittest.TestCase):
    """GenesFromTranscripts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenesFromTranscripts:
        """Test GenesFromTranscripts
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenesFromTranscripts`
        """
        model = GenesFromTranscripts()
        if include_optional:
            return GenesFromTranscripts(
                source = '',
                source_url = '',
                version = '',
                gene = None,
    ...
    def testGenesFromTranscripts(self):
        """Test GenesFromTranscripts"""
