...
class TestProteinsFromGenes200ResponseInner(unittest.TestCase):
    """ProteinsFromGenes200ResponseInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProteinsFromGenes200ResponseInner:
        """Test ProteinsFromGenes200ResponseInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProteinsFromGenes200ResponseInner`
        """
        model = ProteinsFromGenes200ResponseInner()
        if include_optional:
            return ProteinsFromGenes200ResponseInner(
                gene = None,
                protein = None
            )
        else:
    ...
    def testProteinsFromGenes200ResponseInner(self):
        """Test ProteinsFromGenes200ResponseInner"""
