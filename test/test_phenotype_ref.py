...
class TestPhenotypeRef(unittest.TestCase):
    """PhenotypeRef unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PhenotypeRef:
        """Test PhenotypeRef
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PhenotypeRef`
        """
        model = PhenotypeRef()
        if include_optional:
            return PhenotypeRef(
