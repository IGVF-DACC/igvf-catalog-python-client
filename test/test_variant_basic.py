...
class TestVariantBasic(unittest.TestCase):
    """VariantBasic unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VariantBasic:
        """Test VariantBasic
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VariantBasic`
        """
        model = VariantBasic()
        if include_optional:
            return VariantBasic(
