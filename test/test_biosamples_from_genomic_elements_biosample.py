...
class TestBiosamplesFromGenomicElementsBiosample(unittest.TestCase):
    """BiosamplesFromGenomicElementsBiosample unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BiosamplesFromGenomicElementsBiosample:
        """Test BiosamplesFromGenomicElementsBiosample
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BiosamplesFromGenomicElementsBiosample`
        """
        model = BiosamplesFromGenomicElementsBiosample()
        if include_optional:
            return BiosamplesFromGenomicElementsBiosample(
                uri = '',
                term_id = '',
                name = '',
                synonyms = [
    ...
    def testBiosamplesFromGenomicElementsBiosample(self):
        """Test BiosamplesFromGenomicElementsBiosample"""
