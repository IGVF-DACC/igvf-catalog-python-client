...
class TestTargetGene(unittest.TestCase):
    """TargetGene unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TargetGene:
        """Test TargetGene
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TargetGene`
        """
        model = TargetGene()
        if include_optional:
            return TargetGene(
