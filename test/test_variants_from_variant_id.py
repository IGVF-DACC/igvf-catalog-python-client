...
class TestVariantsFromVariantID(unittest.TestCase):
    """VariantsFromVariantID unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VariantsFromVariantID:
        """Test VariantsFromVariantID
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VariantsFromVariantID`
        """
        model = VariantsFromVariantID()
        if include_optional:
            return VariantsFromVariantID(
                chr = '',
                ancestry = '',
                d_prime = 1.337,
                r2 = 1.337,
    ...
    def testVariantsFromVariantID(self):
        """Test VariantsFromVariantID"""
