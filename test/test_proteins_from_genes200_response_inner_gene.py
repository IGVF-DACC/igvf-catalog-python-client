...
class TestProteinsFromGenes200ResponseInnerGene(unittest.TestCase):
    """ProteinsFromGenes200ResponseInnerGene unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProteinsFromGenes200ResponseInnerGene:
        """Test ProteinsFromGenes200ResponseInnerGene
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProteinsFromGenes200ResponseInnerGene`
        """
        model = ProteinsFromGenes200ResponseInnerGene()
        if include_optional:
            return ProteinsFromGenes200ResponseInnerGene(
                id = '',
                chr = '',
                start = 1.337,
                end = 1.337,
    ...
    def testProteinsFromGenes200ResponseInnerGene(self):
        """Test ProteinsFromGenes200ResponseInnerGene"""
