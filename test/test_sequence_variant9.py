...
class TestSequenceVariant9(unittest.TestCase):
    """SequenceVariant9 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SequenceVariant9:
        """Test SequenceVariant9
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SequenceVariant9`
        """
        model = SequenceVariant9()
        if include_optional:
            return SequenceVariant9(
                id = '',
                chr = '',
                pos = 1.337,
                rsid = [
