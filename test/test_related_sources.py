...
class TestRelatedSources(unittest.TestCase):
    """RelatedSources unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RelatedSources:
        """Test RelatedSources
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RelatedSources`
        """
        model = RelatedSources()
        if include_optional:
